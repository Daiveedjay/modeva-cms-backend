...
func GetCategories(c *gin.Context) {
	...
	// Step 2: Count total parent categories (where parent_id IS NULL)
	var total int64
	...
	// Step 3: Fetch parent categories with their children
	...
	// Step 4: Get product counts for all categories
	...
	// Step 5: Transform to CategoryWithProducts
